...
---
## Research Directions
### Hafnium oxide based ferroelectric materials and devices 
...
1. Study of ferroelectric materials mechanisms based on novel fabrication and characterization techniques
2. FeFETs optimzation for high reliability and high memory density
3. Device-Array-Circuit co-optimization for novel computing architecture

### Novel device and architecture based on phase change oxide
...
1. 基于新生长方法和表征技术的铁电材料原理研究
2. 高可靠性的FeFET器件制备与集成
3. 面向新型计算架构的器件-阵列-电路协同优化
